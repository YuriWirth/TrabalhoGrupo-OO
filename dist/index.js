...
const Loja_1 = __importDefault(require("./model/Loja"));
const Produto_1 = __importDefault(require("./model/Produto"));
const produto1 = new Produto_1.default("Skin", 1600, 3);
const cliente1 = new Cliente_1.default("Jamal");
const loja1 = new Loja_1.default();
